...
void RegisterSharedScriptConstants()
{
	...
	ScriptRegisterConstantNamed( g_pScriptVM, (1<<16), "EFL_PLUGIN_BASED_BOT", "Entity flag used in GetEFlags(), etc." );
	...
	ScriptRegisterConstantNamed( g_pScriptVM, 0x0200, "FSOLID_COLLIDE_WITH_OWNER", "Solid flag used in GetSolidFlags(), etc." );
	...
	ScriptRegisterConstant( g_pScriptVM, ROPE_NO_WIND, "Wind simulation on this rope. (for use in rope flags)" );
	...
	ScriptRegisterConstantNamed( g_pScriptVM, 0x40000000, "SOUND_CONTEXT_OWNER_ALLIES", "Sound context used in QueryHearSound hooks, etc." );
