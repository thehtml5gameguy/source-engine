...
public:
	...
	{
		Vector vHalfExpand;
		VectorMax( Vector( 0,0,0 ), vMinSize - GetSize(), vHalfExpand );
		vHalfExpand * 0.5f;
...
{
	Vector vMin;
	VectorMin( aabb1.m_vMinBounds, aabb2.m_vMinBounds, vMin );
	Vector vMax;
	VectorMax( aabb1.m_vMaxBounds, aabb2.m_vMaxBounds, vMax );
